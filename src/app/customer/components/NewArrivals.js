...
import { Sparkles, Star, Tag, Zap, Package } from 'lucide-react';
...
const NewArrivals = () => {
  ...
  if (loading) {
    return <BeautifulLoader message="Loading new arrivals..." />;
  }
  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-b from-white via-purple-50/30 to-white relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-purple-200/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-pink-200/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.h2
            className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 bg-clip-text text-transparent"
          ...
          <>
            ...
            >
              ...
              {product.discount && (
                        ...
                        {/* New Badge */}
                        <motion.div
                          className="absolute top-3 right-3 z-20 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-bold px-2.5 py-1 rounded-full shadow-lg"
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
                        ...
                        <div className="relative h-48 md:h-56 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 flex-shrink-0">
                          ...
                          {/* Quick Add Button */}
                          <motion.button
                            className="absolute bottom-4 right-4 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 text-white h-12 w-12 rounded-full shadow-xl flex items-center justify-center z-30 relative overflow-hidden border-2 border-white/20 backdrop-blur-sm"
                            whileHover={{ 
                              scale: 1.15,
                          ...
                          >
                            ...
                            <motion.div
                              className="absolute inset-0 bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500 rounded-full"
                              animate={{
                                rotate: [0, 360],
                              }}
                              transition={{
                        ...
                        <div className="p-4 flex-1 flex flex-col">
                          ...
                          {/* Product Name */}
                          <h3
                            className="text-sm font-semibold text-gray-800 mb-auto line-clamp-2 group-hover:text-purple-600 transition-colors duration-200"
                            onClick={() => handleProductClick(product.slug)}
                          >
                      ...
                      <motion.div
                        className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl -z-10 transition-opacity duration-300"
                      />
                    </motion.div>
                );
              })}
            ...
            {visibleProducts < products.length && (
              ...
              >
                <motion.button
                  className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
