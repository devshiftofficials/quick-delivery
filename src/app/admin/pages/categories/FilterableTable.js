...
const FilterableTable = () => {
  ...
  const [editingCategorySlug, setEditingCategorySlug] = useState(null); // Track if we're editing
  ...
  const handleAddNewItem = async () => {
    ...
    try {
      ...
      // Only update if we're actually editing an existing category
      const response = editingCategorySlug
  ...
  const handleEditItem = (item) => {
    ...
    setImage(null);
    setImagePreview(null);
    setEditingCategorySlug(item.slug); // Set the slug we're editing
    setIsModalOpen(true);
  };
      ...
      <Fade in timeout={600}>
                      ...
                      {paginatedData.length === 0 ? (
                        <TableRow>
                          <TableCell colSpan={6} align="center" sx={{ py: 8 }}>
                            ...
                            >
                              <Folder size={64} style={{ color: '#9ca3af' }} />
        ...
        >
                ...
                <Typography variant="h5" sx={{ fontWeight: 800 }}>
                  {editingCategorySlug ? 'Edit Category' : 'Add New Category'}
          </Typography>
              </Box>
              <IconButton
                onClick={() => {
            ...
            <Grid item xs={12}>
              ...
              <Grid item xs={12}>
                  ...
                  >
                    ...
                    {(imagePreview || (newCategory.imageUrl && getImageUrl(newCategory.imageUrl))) && (
                      <Box sx={{ mb: 2 }}>
                        <Box
                          sx={{
                            position: 'relative',
                        ...
                        >
                          {imagePreview ? (
                            ...
                            />
                          ) : newCategory.imageUrl && getImageUrl(newCategory.imageUrl) ? (
                            <>
                <Image
                                width={150}
                                height={150}
                  src={getImageUrl(newCategory.imageUrl)}
              ...
              <input
                type="file"
                      ...
                      <label htmlFor="category-image-upload">
                        ...
                        >
                          {newCategory.imageUrl ? 'Change Image' : 'Upload Image'}
                        </Button>
                      </label>
