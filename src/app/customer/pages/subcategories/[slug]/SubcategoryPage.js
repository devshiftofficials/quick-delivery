                ...
                >
                  ...
                  >
                    ...
                    <div className="relative h-48 md:h-56 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 flex-shrink-0">
                      ...
                      {/* Quick Add Button */}
                      <motion.button
                        className="absolute bottom-4 right-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 text-white h-12 w-12 rounded-full shadow-xl flex items-center justify-center z-30 relative overflow-hidden border-2 border-white/20 backdrop-blur-sm"
                        whileHover={{ 
                          scale: 1.15,
