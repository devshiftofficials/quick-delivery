                          ...
                          >
                            ...
                            >
                              ...
                              <div className="relative h-48 md:h-56 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
                                ...
                                {/* Quick Add Button */}
                                <motion.button
                                  className="absolute bottom-3 right-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white h-10 w-10 rounded-full shadow-lg flex items-center justify-center z-20 group/btn"
